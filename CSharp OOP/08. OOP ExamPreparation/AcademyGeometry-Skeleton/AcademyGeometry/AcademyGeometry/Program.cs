...
namespace GeometryAPI
{
    ...
    public class Cylinder : Figure, IVolumeMeasurable, IAreaMeasurable
    {
        ...
        public double GetArea()
        {
            double baseSize = Math.PI * this.Radius * this.Radius;
            return (baseSize * 2) + (2 * Math.PI * this.Radius) * (this.vertices[0] - this.vertices[1]).Magnitude;
        }
    }
                ...
                case "normal":
                    {
                        ...
                        {
                            Console.WriteLine((this.currentFigure as IFlat).GetNormal());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
